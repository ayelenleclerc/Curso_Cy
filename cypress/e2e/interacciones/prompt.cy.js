describe('Interacciones con el navegador', () => {
    ...
    it('probando el prompt', () => {
        ...
        cy.window().then((win)=> {
            ...
            //En Cypress, cy.stub() es un comando que devuelve un valor(el stub,
            // en este caso devolverá Pepe) de forma sincrónica,
            // en lugar de devolver un objeto encadenable tipo Promise.
        })
        cy.get('#btn').click()
